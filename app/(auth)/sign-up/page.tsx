    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '400px' }}>
        ...
        <div style={{
          ...
          {message && (
            <p style={{ fontSize: '13px', color: '#6B9E7A', padding: '10px 14px', background: 'rgba(74,124,89,0.15)', borderRadius: '8px', marginBottom: '14px' }}>
              {message}
            </p>
          )}
        ...
        <p style={{ textAlign: 'center', marginTop: '20px', fontSize: '13px', color: '#BDB5A0' }}>
          ...
          <Link href="/sign-in" style={{ color: '#C9A227', textDecoration: 'none', fontWeight: 500 }}>
            Sign in
          </Link>
        </p>
      </div>
